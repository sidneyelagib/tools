# Generated by Powerlevel10k configuration wizard on 2019-12-01 at 11:18 EET.
...
# angled separators, sharp heads, flat tails, 2 lines, dotted, right frame, lightest,
...
() {
  ...
  typeset -g POWERLEVEL9K_DATE_FORMAT='%D{%H:%M %d.%m.%Y}'
  ...
  #Custom
      ...
      local speed=$(echo $output | grep 'lastTxRate' | awk -F': ' '{print $2}')
	    ...
	    # Wifi off
	    if [[ -z "${signal// }" ]] ;
	      then color='yellow' ; symbol=$'\uf204' ; # Toggle off icon
	    fi
